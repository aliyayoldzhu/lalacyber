...
export const products: Product[] = [
  // Firewalls
  {
    ...
    description:
      "Enterprise-grade next-generation firewall with advanced threat protection, web filtering, and intrusion prevention system.",
    features: [
  ...
  },
  {
    ...
    description:
      "AI-powered next-generation firewall with machine learning-based threat detection and advanced behavioral analytics.",
    features: [
  ...
  // Switches
  {
    ...
    description:
      "Reliable Layer 2 switch with advanced security features, QoS, and energy efficiency for enterprise networks.",
    features: [
  ...
  },
  {
    ...
    description:
      "High-performance Layer 3 switch with advanced routing capabilities, network analytics, and cloud management.",
    features: [
      "24x 1GbE RJ45 Ports",
      "4x 10GbE SFP+ Ports",
      "Layer 3 Routing",
  ...
  // Routers
  {
    ...
    description:
      "Integrated services router with advanced security, unified communications, and application services.",
    features: [
      "Integrated Security",
  ...
  },
  {
    ...
    description:
      "High-performance gaming router with advanced QoS, network monitoring, and gaming acceleration.",
    features: [
      "Gaming Dashboard",
      "Dynamic QoS",
      "Gaming VPN",
  ...
  // Laptops
  {
    ...
    description:
      "Professional mobile workstation with enterprise security features, powerful performance for security analysis.",
    features: [
  ...
  },
  {
    ...
    description:
      "Ultra-premium business laptop with advanced security features and AI-powered performance optimization.",
    features: [
  ...
  // Servers
  {
    ...
    description:
      "High-performance 2U rack server optimized for security workloads and enterprise applications.",
    features: [
  ...
  },
  {
    ...
    description:
      "Intelligent 2U rack server with security-first architecture and advanced threat detection capabilities.",
    features: [
  ...
  // Access Points
  {
    ...
    description:
      "High-performance Wi-Fi 6E access point with advanced security features and enterprise management.",
    features: [
      "Wi-Fi 6E (6 GHz)",
      "4x4 MU-MIMO",
      "Advanced Security",
  ...
  },
  {
    ...
    description:
      "Enterprise-grade Wi-Fi 6 access point with AI-powered analytics and advanced threat detection.",
    features: [
      "Cisco DNA Spaces",
      "AI Analytics",
      "Advanced Security",
